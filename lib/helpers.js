...
exports.getAllRolls = exports.peek = exports.getPropertyByPath = exports.objectMakerReduceHelper = void 0;
 ...
 * @returns {object}
 */
const objectMakerReduceHelper = (accum, [key, val]) => ({ ...accum,
  [key]: val
});
/**
...
exports.objectMakerReduceHelper = objectMakerReduceHelper;

const getPropertyByPath = (value, path) => path.length === 0 ? value : value && typeof value === 'object' ? getPropertyByPath(value[path[0]], path.slice(1)) : undefined;
/**
...
const peek = array => Array.isArray(array) && array.length > 0 ? array[array.length - 1] : undefined;
/**
...
const getAllRolls = rolls => Object.values(rolls).reduce((accum, newRolls) => [...accum, ...newRolls], []);

 ...
 * @property {Object.<number, string[]>} rolls    Map from number of sides to saved roll results
 *                                               (e.g., {6: ['1(d6)','5(d6)']})
 ...
 * @property {Object.<string, ResultEntry>} sideEffects  Applied side effects this run
 */
 ...
 * @param {RPNTokenList[]} expressions Expressions to evaluate
 * @param {MacroMap} macros Macros referenced by these expressions / by other macros
 * @param {Object<number,string[]>} [rolls={}] Saved rolls (by number of sides), in case of reevaluation
 *
 * @returns {Object}
 */
